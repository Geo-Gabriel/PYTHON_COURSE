...
#       A primeira lista é o cabeçalho que diz o que significa cada lista a seguir. Ex: Lista de frutas, lita de verduras
#       lista de legumes.
...
print(f'{lista[0][0]} : {lista[1][2]} e {lista[1][4]} - {lista[0][1]}: {lista[2][4]} e {lista[2][2]} - {lista[0][2]}: {lista[3][1]}, {lista[3][4]} e {lista[3][5]} ')
...
##################################################################################################################
print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg de soja,'
      '1 pacote de ervilha')

print(f'{lista[0][2]}: 1kg de {lista[3][0]}, 2kg de {lista[3][5]}, 1.5kg de {lista[3][6]} e 1 pacote de {lista[3][1]}')
