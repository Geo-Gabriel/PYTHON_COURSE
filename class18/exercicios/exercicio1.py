...
print(f'{lista[3]} é muito bom, sinto muito {lista[2]} quano eu chupo {lista[4]} deles')
...
print(f'{lista[5]} - {lista[3]} - {lista[0]} - {lista[6]} - {1} - {4}')
...
print(f'namor {lista[0]} - {lista[0]} - {lista[3]} - {lista[6]} - {lista[5]} - {lista[0]} - {lista[1]}')
