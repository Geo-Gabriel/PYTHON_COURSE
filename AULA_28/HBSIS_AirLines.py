...
lista=['Piloto','Oficial1','Oficial2','ChefeDeServico','Comissaria1','Comissaria2','Bandido','Policia']



def levar_comissaria1(lista[0][4]):
    #Fica a 1 comissaria
    return piloto

def levar_comissaria2(lista[0][5]):
    #Fica a 2 comissaria
    return piloto

def levar_oficial1(lista[3][1]):
    #Fica o oficial1
    return chefe_de_servico

def levar_oficial2(lista[3][2]):
    #Fica o oficial2
    return chefe_de_servico

def Policia_e_ladrao(lista[6][7]):
    #Fica a policia e o ladrao e volta o oficial2
    return oficial2
 
def lev_oficial2(lista[3][2]):
    #fica o oficial2 e volta o chefe de servico de voo
    return chefe_de_servico

def levar_chefe_e_piloto(lista[0][3]):
    #fica o chefe de servico de voo e o piloto
